...
const NewBlog = () => {
  ...
  const addNewBlog = async (blogObject) => {
    try {
      ...
      const notif2 = {
        message: `Não pode adicionado este post`,
        type: "failure",
      };
              ...
              <form onSubmit={addBlog} className="flex flex-col gap-4">
                <div>
                  <div className="mb-2 block">
                    <Label htmlFor="post-title" value="Título do post" />
                  </div>
                  <TextInput
                    id="post-title"
                    type="text"
                    placeholder="Uma postagem incrível"
                    required={true}
                    value={newTitle}
                ...
                <div>
                  <div className="mb-2 block">
                    <Label htmlFor="post-content" value="Conteúdo do post" />
                  </div>
                  <Textarea
                    required={true}
                    value={newContent}
